/******/ (() => {
  ...
  \*****************************/
            /***/ (
                ...
                /* harmony export */ __webpack_require__.d(
                    __webpack_exports__,
                    {
                        /* harmony export */ getAirQuality: () =>
                            /* binding */ getAirQuality,
                        /* harmony export */ getForecast: () =>
                            /* binding */ getForecast,
                        /* harmony export */ getWeather: () =>
                            /* binding */ getWeather,
                        /* harmony export */
                    }
                );
  ...
  \*****************************/
            /***/ (
                ...
                /* harmony export */ __webpack_require__.d(
                    __webpack_exports__,
                    {
                        /* harmony export */ endLoadingAnimation: () =>
                            /* binding */ endLoadingAnimation,
                        /* harmony export */ populateAirQuality: () =>
                            /* binding */ populateAirQuality,
                        /* harmony export */ populateCurrentWeather: () =>
                            /* binding */ populateCurrentWeather,
                        /* harmony export */ populateForecast: () =>
                            /* binding */ populateForecast,
                        /* harmony export */ populateLocation: () =>
                            /* binding */ populateLocation,
                        /* harmony export */ startLoadingAnimation: () =>
                            /* binding */ startLoadingAnimation,
                        /* harmony export */
                    }
                );
                ...
                function populateCurrentWeather(data) {
                    ...
                    for (const property in data) {
                        if (property == "Date") {
                            ...
                            const time = (0,
                            _utils__WEBPACK_IMPORTED_MODULE_0__.convertTime)(
                                data[property][1],
                                hour,
                                minute
                            );
                            ...
                            currentConditionName.innerHTML = `${(0,
                            _utils__WEBPACK_IMPORTED_MODULE_0__.capitalizeFirstLetters)(
                                data[property][0]
                            )}`;
                            ...
                            if (property == "Location") {
                                ...
                                _utils__WEBPACK_IMPORTED_MODULE_0__.convertWindDirection)(
                                    data[property][1]
                                )}`;
                            } else {
                                weatherItemProperty.innerHTML = `${property}`;
                ...
                function populateAirQuality(data) {
                    const airQualityContainer = document.querySelector(
                        ".airQualityContainer"
                    );

                    const airQualityDisplay =
                        document.querySelector(".airQualityDisplay");
                    ...
                    const airQualityHeader =
                        document.querySelector(".airQualityHeader");
                    const airQualityPara =
                        document.querySelector(".airQualityPara");
                    ...
                    const ozoneValue = document.querySelector(
                        ".componentOzone .value"
                    );
                    const N2Value = document.querySelector(
                        ".componentNitrogenDioxide .value"
                    );
                    const finePMValue = document.querySelector(
                        ".componentFinePM .value"
                    );
                    const PMValue = document.querySelector(
                        ".componentPM .value"
                    );
                    ...
                    const airQualityBtn =
                        document.querySelector(".airQualityBtn");
                    airQualityBtn.addEventListener("click", () => {
                        airQualityContainer.classList.toggle(
                            "expandAirQuality"
                        );
                    ...
                    for (let i = 0; i < 8; i++) {
                        ...
                        for (const property in tileData) {
                            if (property == "Date") {
                                ...
                                const forecastItemProperty =
                                    document.createElement("div");
                                const forecastItemData =
                                    document.createElement("div");

                                forecastItemProperty.classList.add(
                                    "forecastItemProperty"
                                );
                                forecastItemData.classList.add(
                                    "forecastItemData"
                                );
                ...
                function startLoadingAnimation() {
                    ...
                    const outerWrappers =
                        document.querySelectorAll(".outerWrapper");
  ...
  \**********************/
            /***/ (
                ...
                /* harmony export */ __webpack_require__.d(
                    __webpack_exports__,
                    {
                        /* harmony export */ capitalizeFirstLetters: () =>
                            /* binding */ capitalizeFirstLetters,
                        /* harmony export */ convertTime: () =>
                            /* binding */ convertTime,
                        /* harmony export */ convertWindDirection: () =>
                            /* binding */ convertWindDirection,
                        /* harmony export */
                    }
                );
  ...
  \**********************/
        __webpack_require__.r(__webpack_exports__);
        /* harmony import */ var _apiFunctions__WEBPACK_IMPORTED_MODULE_0__ =
            __webpack_require__(/*! ./apiFunctions */ "./src/apiFunctions.js");
        /* harmony import */ var _domFunctions__WEBPACK_IMPORTED_MODULE_1__ =
            __webpack_require__(/*! ./domFunctions */ "./src/domFunctions.js");
        ...
        async function processWeather(location) {
            ...
            const weatherData = await (0,
            _apiFunctions__WEBPACK_IMPORTED_MODULE_0__.getWeather)(location);

            console.log(weatherData);

            let importantData = {};

            importantData.Location = [
                weatherData.name,
            ...
            importantData[
                "Feels Like"
            ] = `${weatherData.main.feels_like} &#8451`;
        ...
        async function processAirQuality(location) {
            ...
            const airQualityData = await (0,
            _apiFunctions__WEBPACK_IMPORTED_MODULE_0__.getAirQuality)(location);
        ...
        async function processForecast(location) {
            ...
            const forecastData = await (0,
            _apiFunctions__WEBPACK_IMPORTED_MODULE_0__.getForecast)(location);
            ...
            for (const index in forecastData.list) {
                ...
                importantData[index].Wind = {
                    speed: `${
                        Math.round(
                            forecastData.list[index].wind.speed * 3.6 * 100
                        ) / 100
                    } km/hr`,
                    direction: forecastData.list[index].wind.deg,
                };
                importantData[index].Gust = `${
                    Math.round(forecastData.list[index].wind.gust * 3.6 * 100) /
                    100
                } km/hr`;
            }
        ...
        async function loadPage(location) {
            ...
            (0,
            _domFunctions__WEBPACK_IMPORTED_MODULE_1__.startLoadingAnimation)();
            ...
            Promise.all([
                ...
                .then((data) => {
                    //console.log(data);
                    (0,
                    _domFunctions__WEBPACK_IMPORTED_MODULE_1__.populateLocation)(
                        data[0]
                    );
                    (0,
                    _domFunctions__WEBPACK_IMPORTED_MODULE_1__.populateCurrentWeather)(
                        data[0]
                    );
                    (0,
                    _domFunctions__WEBPACK_IMPORTED_MODULE_1__.populateAirQuality)(
                        data[1]
                    );
                    (0,
                    _domFunctions__WEBPACK_IMPORTED_MODULE_1__.populateForecast)(
                        data[2]
                    );
                })
                .catch((error) => {
                ...
                .finally(() => {
                    (0,
                    _domFunctions__WEBPACK_IMPORTED_MODULE_1__.endLoadingAnimation)();
                });
...
/******/ })()
;
//# sourceMappingURL=data:application/json;charset=utf-8;base64,